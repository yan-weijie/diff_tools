...
export const demoNew = {
  ...
  data: {
    list: [
      { skuId: 67287295489, storeId: '1005517860', shopName: '京东自营旗舰店', dealPrice: 199.0, status: 1, tags: ['热销', '新品'] },
...
export const demoOld = {
  ...
  data: {
    dataList: [
      { sku_id: 67287295489, store_id: 1005517860, shop_name: '京东自营旗舰店', deal_price: 199.0, status: 1 },
